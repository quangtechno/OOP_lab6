...
public class Student implements Serializable{
    ...
    public String toString() {
        return "Student{" + "studentID=" + studentID + ", lastName=" + lastName + ", midName=" + midName + ", firstName=" + firstName + ", yearOfBirth=" + yearOfBirth + ", gender=" + gender + ", schoolStage=" + schoolStage + '}';
    }
